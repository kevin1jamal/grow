...
class SettingPinConfirmNewFormScreen extends StatefulWidget {
  const SettingPinConfirmNewFormScreen({Key? key}) : super(key: key);

  @override
  State<SettingPinConfirmNewFormScreen> createState() => _SettingPinConfirmNewFormScreenState();
}

class _SettingPinConfirmNewFormScreenState extends State<SettingPinConfirmNewFormScreen> {
  ...
  _onKeyboardTap(String value) {
    setState(() {
      ...
      if(pinController.text.length == 4){
        Navigator.pushNamed(context, '/settings/pin-code/validate');
      }
    });
  }
  @override
